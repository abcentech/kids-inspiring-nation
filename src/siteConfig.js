...
export const SITE = {
  ...
  // Main-site email capture → Brevo "KIN Web Signups" list.
  brevoFormUrl: import.meta.env.VITE_BREVO_FORM_URL ||
    "https://1bed281f.sibforms.com/serve/MUIFACSsH7Ytd7coa1D0ASBordOJ7pM88TbbuDFpn-HFcNqoc4KJbMq-dllTdiFY25PgaLC_yj9vzCSuLCyxaRI5ZlxbxPaMmT3ce2zVZb9jfdmRbteBAzhgAQ6NNdDfjmqK9ISZEovciP3022KVN4i8LvU9vTh5gfvqfbxB0D1igJ64z5rWucHyfYFhXPPtEGGbz5RumXW0jMuZbQ==",
  // NBC "Join the builders' network" capture → Brevo "NBC Builders Network" list.
  nbcBrevoFormUrl:
